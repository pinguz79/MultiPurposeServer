...
namespace Finance.Desktop
{
    ...
    {
        private IReadOnlyList<ITemporalDefinition> _definitions = [];

        public void SetDefinitions(IReadOnlyList<ITemporalDefinition> definitions)
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                ITemporalDefinition definition = _definitions[index];
        ...
        private void DrawDefinition(Graphics graphics, ITemporalDefinition definition, int definitionIndex, DateOnly[] boundaries)
        {
        ...
        private static bool Covers(ITemporalDefinition definition, DateOnly? from, DateOnly? to)
        ...
        private static bool Intersects(ITemporalDefinition definition, DateOnly? from, DateOnly? to)
