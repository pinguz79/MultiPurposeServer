...
namespace Finance.Api.Tests.Pipeline
{
    public class MovimentoPipelineTests
    {
        ...
        public async Task BulkCreateMissingContoReturnsNotFoundBeforeProcessingItems()
        {
            ...
            host.MovimentoService.Verify(service => service.Create(It.IsAny<Guid>(), It.IsAny<DateOnly>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<NaturaMovimento>(), It.IsAny<string?>()), Times.Never);
        }
    }
}
