...
namespace Portfolio.Api.Tests.Controllers.BackEnd.Bulk
{
    public class AlbumControllerTests
    {
        ...
        public AlbumControllerTests()
        {
            ...
            _controller = new AlbumController(_albumService.Object);
        }
        ...
        public async Task Update_WhenOnlyNameIsSpecified_UpdatesNameAndCompletesOperation()
        {
            ...
            var request = new BulkUpdateAlbumRequest(new BulkOptions(), [new BulkUpdateAlbumItem(albumId, "Fashion Milano", null)]);
        ...
        public async Task Update_WhenOnlyDescriptionIsSpecified_UpdatesDescriptionAndCompletesOperation()
        {
            ...
            var request = new BulkUpdateAlbumRequest(new BulkOptions(), [new BulkUpdateAlbumItem(albumId, null, "Fashion photography")]);
        ...
        public async Task Update_WhenNameAndDescriptionAreSpecified_UpdatesBothFieldsAndCompletesOperation()
        {
            ...
            var request = new BulkUpdateAlbumRequest(new BulkOptions(), [new BulkUpdateAlbumItem(albumId, "Fashion Milano", "New description")]);
